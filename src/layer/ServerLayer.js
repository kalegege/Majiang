 ...
 */
var ServerLayer=ccui.Layout.extend({
    _backGroud:null,
    _textFiled:null,
    _close:null,
    ...
    ctor:function () {
        ...
        var btn = new cc.Sprite(res.bg_input_down_png);
        ...
        var _btnListener = cc.EventListener.create({
            ...
            onTouchBegan: function (touch, event) {
                ...
                Game.server =this._textFiled.getString();
    ...
    loadTextField:function () {
        ...
        this._textFiled.setString(Game.server);
